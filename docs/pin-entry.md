# Frankencard PIN Design and Operation

## What happens when I enter a PIN?

1) Enter between 2 and 6 digits of your PIN code prefix and press OK (checkmark).

2) The Frankencard will use those digits to find two specific words from the BIP39
word list. This two word response is unique to your Frankencard and pin combination.
...
6) Is it the user-defined "brick me" PIN? If so, it's used to wipe
    the secure element and **irreversibly brick** the Frankencard immediately. There is no
...
So if there are wires connected to the Frankencard while you are being
...
the brick-me PIN works, the Frankencard will immediately use it to
...
- You might not be able to directly touch the subject Frankencard at the critical moment.
...
secret, the hashes generated by each Frankencard will be different.
...
## How To Develop Professional Code on Frankencard
...
Idea: Find or steal a Frankencard. Load your trojan firmware onto it. Profit.
...
- weak solution: "helpfully" power up the Frankencard for them, and say... "Here it
  is ready for your pin, sir. No idea why the light is red today."
- so we need to warn users to power up the Frankencard themselves every time they enter the PIN.

## Four Types of wallets, one Frankencard

The Frankencard before Mark 3, effectively supported four independent wallets:
...
When creating the duress wallet, Frankencard derives the wallet root
...
The duress wallet operates like any other wallet on the Frankencard.
...
words into a new Frankencard, and assign a duress PIN again. Then login
...
this a simple test that they are talking to their Frankencard, and not
a doppelgänger.
...
Frankencard wallet, they could enter the prefix and note the words
displayed. From there, they could make a replacement Frankencard that
...
particular subject Frankencard are to be captured, the bootloader
...
improve Frankencard security as follows:
...
- Using a HMAC-SHA256 inside the chip, we create a HMAC chain using a secret
  known only to the secure element (and unique per Frankencard) as the
