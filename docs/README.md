# Frankencard Internal Documentation

These docs are meant for you hackers out there... but also for anyone who
wants to understand how the firmware works. (This fork makes no safety claim --
see ../DISCLAIMER.md.)
...
- [`dev-access.md`](dev-access.md) How developers can modify Frankencard to extend it.
...
- [`msg-signing.md`](msg-signing.md) FRANKENCARD message signing.
...
- [`bip-21-extensions.md`](bip-21-extensions.md) Frankencard's BIP-21 URI extensions, including multisig ownership address check.
- [`nfc-coldcard.md`](nfc-coldcard.md) NFC support on Frankencard Mk4 and Q.
- [`nfc-pushtx.md`](nfc-pushtx.md) NFC Push Transaction: broadcast a signed transaction via your phone.
- [`usb-batteries.md`](usb-batteries.md) Using USB battery packs with Frankencard.
